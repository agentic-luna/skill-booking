...
export const env = {
  ...
  // Meta Cloud API Specific Configurations
  META_WHATSAPP_ACCESS_TOKEN: process.env.META_WHATSAPP_ACCESS_TOKEN ?? process.env.WHATSAPP_ACCESS_TOKEN ?? process.env.META_WA_ACCESS_TOKEN ?? "",
  META_WHATSAPP_PHONE_NUMBER_ID: process.env.META_WHATSAPP_PHONE_NUMBER_ID ?? process.env.WHATSAPP_PHONE_NUMBER_ID ?? process.env.META_WA_PHONE_NUMBER_ID ?? "",
  META_WHATSAPP_API_VERSION: process.env.META_WHATSAPP_API_VERSION ?? "v20.0",
};
