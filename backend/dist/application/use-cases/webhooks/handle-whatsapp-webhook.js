...
exports.HandleWhatsAppWebhookCommandHandler = exports.HandleWhatsAppWebhookCommand = void 0;
class HandleWhatsAppWebhookCommand {
    payload;
    __tag = 'HandleWhatsAppWebhookCommand';
    constructor(payload) {
        this.payload = payload;
    }
}
exports.HandleWhatsAppWebhookCommand = HandleWhatsAppWebhookCommand;
class HandleWhatsAppWebhookCommandHandler {
    logger;
    constructor(logger) {
        this.logger = logger;
    }
     ...
     */
    logStatusEvent(wabaId, phoneNumberId, statusObj) {
     ...
     */
    logIncomingMessage(wabaId, phoneNumberId, messageObj, senderName) {
        ...
        this.logger.info(`[WhatsApp Webhook] Incoming Message Received | From: ${senderName ? `${senderName} (${from})` : from} | Type: ${type} | Body: "${bodySummary}" | WAMID: ${wamid}`, {
            wabaId,
            phoneNumberId,
            sender: from,
            senderName,
...
exports.HandleWhatsAppWebhookCommandHandler = HandleWhatsAppWebhookCommandHandler;
