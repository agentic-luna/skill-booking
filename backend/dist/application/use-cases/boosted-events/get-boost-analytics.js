...
exports.GetBoostAnalyticsQueryHandler = exports.GetBoostAnalyticsQuery = void 0;
const errors_1 = require("../../common/errors");
const prisma_1 = require("../../../config/prisma");
class GetBoostAnalyticsQuery {
    eventId;
    __tag = 'GetBoostAnalyticsQuery';
    constructor(eventId) {
        this.eventId = eventId;
    }
}
exports.GetBoostAnalyticsQuery = GetBoostAnalyticsQuery;
class GetBoostAnalyticsQueryHandler {
    boostedRepo;
    ...
    async handle(query) {
        ...
        if (!boost) {
            throw new errors_1.NotFoundError('No boost promotion record found for this event.');
        }
        // Get confirmed booking statistics for this event
        const confirmedBookings = await prisma_1.prisma.booking.aggregate({
            where: {
                eventId,
                status: 'CONFIRMED',
            },
...
exports.GetBoostAnalyticsQueryHandler = GetBoostAnalyticsQueryHandler;
