...
exports.generateRefundApprovedEmailTemplate = generateRefundApprovedEmailTemplate;
exports.generateRefundDeclinedEmailTemplate = generateRefundDeclinedEmailTemplate;
function generateRefundApprovedEmailTemplate(data) {
    return `
...
function generateRefundDeclinedEmailTemplate(data) {
    return `
<div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 16px;">
