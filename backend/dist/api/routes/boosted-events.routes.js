...
router.get('/plans', boosted_events_controller_1.BoostedEventsController.getPricing);
router.post('/click', boosted_events_controller_1.BoostedEventsController.trackClick);
router.get('/analytics/:eventId', auth_1.authenticate, boosted_events_controller_1.BoostedEventsController.getAnalytics);
