...
import { 
  ...
  Menu, X, LogOut, ArrowLeftRight, Bell 
} from "lucide-react";
...
export default function AdminLayout({
  ...
  useEffect(() => {
    // If not logged in or role is not admin, redirect appropriately
    if (!isAuthenticated) {
      router.push("/login");
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-center space-x-3 bg-muted/40 p-3 rounded-xl border border-border/20">
          ...
          <div className="min-w-0 flex-1">
            ...
            <span className="text-[10px] text-muted-foreground font-semibold uppercase tracking-wider">Super Admin</span>
          </div>
        </div>
