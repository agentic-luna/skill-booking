...
export default function AuthLayout({
  ...
  return (
    <div className="flex min-h-screen grid-cols-1 lg:grid-cols-12 overflow-hidden">
      ...
      <div className="hidden lg:flex lg:col-span-5 relative flex-col justify-between p-12 text-white gradient-bg border-r border-border/10">
        ...
        {/* Branding Logo */}
        <Link href="/" className="relative z-10 flex items-center space-x-2.5 hover:opacity-90 transition-opacity">
        ...
        <div className="relative z-10 space-y-6 my-auto max-w-md">
          <h1 className="text-4xl font-extrabold tracking-tight text-foreground dark:text-white leading-[1.15]">
            Unlock Your <span className="gradient-text">Potential</span> with Expert Training.
          </h1>
