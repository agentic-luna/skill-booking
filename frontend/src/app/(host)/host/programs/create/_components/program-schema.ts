...
export const programSchema = z.object({
  ...
  questionnaire: z.object({
    whatIsThisProgram: z.string().min(10, "What is this program must be at least 10 characters"),
    whoIsThisFor: z.string().min(5, "Who is this course for must be at least 5 characters"),
    whatWillYouLearn: z.string().min(10, "What will you learn must be at least 10 characters"),
    whatTopics: z.string().min(10, "What topics you will be teaching must be at least 10 characters"),
    mediumOfLanguage: z.string().min(2, "Language must be specified"),
    prerequisites: z.string().optional().or(z.literal("")),
    takeaways: z.string().optional().or(z.literal("")),
    toolsGiven: z.string().optional().or(z.literal("")),
  }),
