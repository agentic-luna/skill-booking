...
```bash
npx componentry@latest add hero-geometric
```
...
|------|------|---------|-------------|
| `title1` | `string` | - | First line of the main headline (serif font). |
| `title2` | `string` | - | Second line of the main headline (sans-serif, bold). |
| `description` | `string` | - | Subtitle text displayed below the headline. |
| `color1` | `string` | `"#3B82F6"` | Primary color for the gradient shader. |
| `color2` | `string` | `"#F0F9FF"` | Secondary color for the gradient shader. |
| `speed` | `number` | `1` | Animation speed multiplier for the shader noise. |
| `className` | `string` | - | Additional CSS classes for the container. |

---

_Component from [Componentry](https://componentry.dev/docs/components/hero-geometric)_